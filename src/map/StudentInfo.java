...
public class StudentInfo {
    ...
    public static void main(String[] args) {
        ...
        email(listOfStudents);
        ArrayList<String > studentEmails=email(listOfStudents);
    ...
    public static ArrayList<String > email(ArrayList<HashMap<String, String>> infoList){
