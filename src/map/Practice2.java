...
public class Practice2 {
    public static void main(String[] args) {
        ...
        /**
         * step1 - get all keys
         * step 2 - if statement to check if fruit starts with 'a' / 'A'
         *
         * step 3 - get the value of that fruit
         */
        ...
        //containsValue() --> it checks if provided element is one of Value on the map
        ...
        System.out.println(map);
        map.replace("Potatoes","DENVER","CHICAGO");
        System.out.println(map);
